...
static const u8 sTypeEffectiveness[][3] = {
    ...
    { TYPE_BUG, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE }, // ~ Not Effective against Bug instead of Ghost
    ...
    { TYPE_BUG, TYPE_FAIRY, TYPE_MUL_SUPER_EFFECTIVE }, //~ Super Effective instead of Not Effective
